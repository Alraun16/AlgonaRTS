...
#include "AlgonaArmySkinnedPresentationActor.generated.h"
...
/**
 * Temporary backend 3 presentation actor.
 *
 * Simulation remains authoritative at 40 Hz. This actor owns only local
 * presentation state, camera visibility and GPU interpolation state.
 */
UCLASS(NotBlueprintable, Transient)
class ALGONARTS_API AAlgonaArmySkinnedPresentationActor final : public AActor
{
	GENERATED_BODY()

public:
	AAlgonaArmySkinnedPresentationActor();
...
private:
	...
	UAnimSequenceTransformProviderData* CreateSequenceProvider(
	...
	bool IsCameraCullingEnabled() const;
	...
	UPROPERTY(VisibleAnywhere, Category = "Algona|Presentation")
	TObjectPtr<UInstancedSkinnedMeshComponent> InstancedSkinnedMeshComponent =
		nullptr;
	...
	// Orthographic screen-significance cache.
